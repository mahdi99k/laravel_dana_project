<script>
	...
	export let showCampAdd;
	export let updated = false;
	export let scores;
	let isUploading = false;
	let error = false;
	let group, start_date, end_date;
...
{#if showCampAdd}
	...
	>
		<div class="flex flex-wrap pb-20">
			<Input bind:val={group} label="نام گروه جهادی" />
			<DateInput bind:val={start_date} label="تاريخ شروع اردو" />
			<DateInput bind:val={end_date} label="تاريخ پایان اردو" />
