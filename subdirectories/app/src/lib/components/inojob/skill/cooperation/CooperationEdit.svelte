<script>
	...
	let title = score.attributes.data.title,
		institute = score.attributes.data.institute,
		start_date = score.attributes.data.start_date,
		approve_date = score.attributes.data.approve_date,
		end_date = score.attributes.data.end_date,
		position = score.attributes.data.position,
		person_amounts = score.attributes.data.person_amounts,
		price = score.attributes.data.price,
