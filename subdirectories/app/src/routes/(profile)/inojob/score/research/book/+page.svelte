<script>
	import BookDetails from '$lib/components/inojob/research/BookDetails.svelte';
	import { fade, slide } from 'svelte/transition';
	import { afterUpdate, onMount } from 'svelte';
	import { getCookie, API_URL } from '$lib/main';
	import axios from 'axios';
	import BookAdd from '$lib/components/inojob/research/BookAdd.svelte';
	import Dropdown from '../../../../../../lib/components/Dropdown.svelte';
	$: updated = false;
	let showBookDetails = false;
	let showBookAdd = true;
	$: isPending = true;
	let error = false;
	let USER;
	$: USER;
	...
	onMount(async () => {
		...
		await axios
			.get(`${API_URL}/getScores/research/book`, {
