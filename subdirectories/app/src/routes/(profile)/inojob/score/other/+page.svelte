<script>
	import OtherDetails from '$lib/components/inojob/other/OtherDetails.svelte';
	import { fade, slide } from 'svelte/transition';
	import { afterUpdate, onMount } from 'svelte';
	import { getCookie, API_URL } from '$lib/main';
	import axios from 'axios';
	import OtherAdd from '$lib/components/inojob/other/OtherAdd.svelte';
	import Dropdown from '../../../../../lib/components/Dropdown.svelte';
	$: updated = false;
	let showOtherDetails = false;
	let showOtherAdd = true;
	$: isPending = true;
	let error = false;
	let USER;
	$: USER;
	...
	onMount(async () => {
		...
		await axios
			.get(`${API_URL}/getScores/culture/other`, {
